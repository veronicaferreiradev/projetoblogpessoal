...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario (null, 
				"Verônica Santos", "veronica@gmail.com.br", "12345678", "-"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(null, 
			"Daniele Silveira", "daniele@email.com.br", "13465278", "-"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(null, 
			"Verônica Santos", "veronicas@email.com.br", "veronica123", "-"));
		
		usuarioService.cadastrarUsuario(new Usuario(null, 
			"Daniele Silveira", "danieles@email.com.br", "daniele123", "-"));
